...
import { Address, Point, Search } from 'react-native-yamap-plus';
...
export const SearchScreen = () => {
  ...
  useEffect(() => {
    Search.searchPoint({ lat: 54, lon: 53 }, 18).then((searchAddress) => {
      console.log('Search.searchPoint', searchAddress);
    });
  }, []);
  ...
  return (
    <View style={styles.container}>
      <TextInput value={text} onChangeText={setText} placeholder="Address" style={styles.textInput} />
